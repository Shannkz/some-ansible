...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Docker containers inventory script")
...
def list_running_hosts():
    """docker.py --list function"""
    cmd = ["docker", "ps", "--machine-readable"]
...
def get_host_details(host):
    """docker.py --host <hostname> function"""
...
def main():
    ...
    if args.list:
        ...
        json.dump({'docker': hosts}, sys.stdout)
    else:
